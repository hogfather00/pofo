...
<template>
    <header class="flex justify-between items-center p-6 bg-opacity-50 relative z-20" id="home">
        <div class="text-3xl font-bold bg-linear-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">
            Vue Reactive Web Design <span class="font-black">Portfolio</span>
        </div>
